...
/** `classificationSnapshot` から復元した 1 ラベル分の値。 */
export interface ClassificationSnapshotLabel {
  accountId: string
 ...
 * `ClassificationSnapshotLabel` の配列へ変換する。crawl 経路が書き込む形状は固定のため、
