...
// NBA/MLB のような略語が無関係な語の内部に一致しないよう、英単語は単語境界で判定している。
// 日本語は単語境界の概念が同様には成り立たないため部分一致のままとしている。
//
// スポーツ は直前の e (全角・半角、大小問わず) を除外している。eスポーツ は topic_gaming 側の
// シグナルとして扱っており、ここに含めると eスポーツ 関連のプレイヤーや会場アカウントを
// 誤ってスポーツ関心ありとして検知してしまうため。
